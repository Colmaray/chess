...
public abstract class ChessComponent extends JComponent {
     ...
     */
    private static Color brown = new Color(128,64,0);
    private static Color kaqi = new Color(195,176,145);
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    protected ChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor, ClickController clickController, int size,char name) {
    ...
    public abstract ArrayList<ChessboardPoint> canMoveTo1();
